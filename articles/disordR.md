...
```
    ...
    ## A disord object with hash 0129f1fbef3b9b9ce869ac6d4960d2d7629d5f5b and elements
    ## [1] 9 4 7 1 2 7 2 3 1
    ## (in some order)
...
```
    ...
    ## A disord object with hash a09f6d665f1ff502ebeb5b493846ccc74f1b0f8c and elements
    ## [1] 5 6 7 9 5 5 9 9 5
    ## (in some order)
...
```
    ...
    ## ! 
    ## hash codes 0129f1fbef3b9b9ce869ac6d4960d2d7629d5f5b and a09f6d665f1ff502ebeb5b493846ccc74f1b0f8c do not match
...
```
    ...
    ## A disord object with hash 08278d7f49ce20e998d368e746182203bc47a4a9 and elements
