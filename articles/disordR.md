...
```
    ...
    ## A disord object with hash 7e8dedc569b2f0ae7f7e41b1abcffa74ad63b1ba and elements
    ## [1] 9 4 7 1 2 7 2 3 1
    ## (in some order)
...
```
    ...
    ## A disord object with hash 0eaedd5aaae4a6f3e58959e7d7f5eab3aa404c74 and elements
    ## [1] 5 6 7 9 5 5 9 9 5
    ## (in some order)
...
```
    ...
    ## ! 
    ## hash codes 7e8dedc569b2f0ae7f7e41b1abcffa74ad63b1ba and 0eaedd5aaae4a6f3e58959e7d7f5eab3aa404c74 do not match
...
```
    ...
    ## A disord object with hash 842bb82b80944fc46f03a941d4f4d2aea72859ba and elements
