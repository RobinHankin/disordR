...
```
    ...
    ## A disord object with hash 7714bc93a9af63a95bc80aa3991f5d368387a753 and elements
    ## [1] 9 4 7 1 2 7 2 3 1
    ## (in some order)
...
```
    ...
    ## A disord object with hash 9f180931bb85284cfb3ca924cb02bc916738270f and elements
    ## [1] 5 6 7 9 5 5 9 9 5
    ## (in some order)
...
```
    ...
    ## ! 
    ## hash codes 7714bc93a9af63a95bc80aa3991f5d368387a753 and 9f180931bb85284cfb3ca924cb02bc916738270f do not match
...
```
    ...
    ## A disord object with hash 4b3ac7a8d5fd9e865c78181ebbd3a950760c3d9e and elements
