...
```
    ...
    ## A disord object with hash 31df8ef5077240a8d1608e1b67622ee98d8e4e35 and elements
    ## [1] 9 4 7 1 2 7 2 3 1
    ## (in some order)
...
```
    ...
    ## A disord object with hash 8ecfb624a66aa6122afd8cfe0977670ef0d42c85 and elements
    ## [1] 5 6 7 9 5 5 9 9 5
    ## (in some order)
...
```
    ...
    ## ! 
    ## hash codes 31df8ef5077240a8d1608e1b67622ee98d8e4e35 and 8ecfb624a66aa6122afd8cfe0977670ef0d42c85 do not match
...
```
    ...
    ## A disord object with hash 76961fa64f7c487d8e8aa1ccb33b4627351166ca and elements
