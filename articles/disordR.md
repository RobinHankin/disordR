...
```
    ...
    ## A disord object with hash b823fd444bb5bc9d2ead026ecb02adc6f7fe74f3 and elements
    ## [1] 9 4 7 1 2 7 2 3 1
    ## (in some order)
...
```
    ...
    ## A disord object with hash d849fb46977d6610091e43acacaa57c081a952ba and elements
    ## [1] 5 6 7 9 5 5 9 9 5
    ## (in some order)
...
```
    ...
    ## ! 
    ## hash codes b823fd444bb5bc9d2ead026ecb02adc6f7fe74f3 and d849fb46977d6610091e43acacaa57c081a952ba do not match
...
```
    ...
    ## A disord object with hash 8f32cb82bb67a7a1df11af905da6529913eb3a67 and elements
