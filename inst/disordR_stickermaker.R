...
s <- s + geom_pkgname(d[2457],size=3.5,x=0.6,y=1.15)
s <- s + geom_pkgname(d[0135],size=3.5,x=0.6,y=0.95)
s <- s + geom_pkgname(d[0121],size=3.5,x=0.6,y=0.75)
s <- s + geom_pkgname(d[1672],size=3.5,x=0.6,y=0.55)

s <- s + geom_pkgname(d[0087],size=3.5,x=1.4,y=1.15)
s <- s + geom_pkgname(d[1529],size=3.5,x=1.4,y=0.95)
