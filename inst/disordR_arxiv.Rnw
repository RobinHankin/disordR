...
\hfill\includegraphics[width=1in]{\Sexpr{system.file("help/figures/disordR.png",package="disordR")}}
...
package~\citep{hankin2022_mvp} which deals with multinomials using
