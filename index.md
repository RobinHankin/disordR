...
Note that in the last line [`zip()`](https://rdrr.io/r/utils/zip.html)
is used to relate `a` and `b` which is accomplished in the package by
explicitly setting the hash code.
