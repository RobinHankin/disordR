...
#> A disord object with hash 2db2250fab9b505f27c11bc0d3ddcc2782c24611 and elements
#> [1] 3 3 3 3 3
#> (in some order)
...
a <- rdis()
a
#> A disord object with hash 03a0af10c9382b3ff8cebeda4d02786fd5390e02 and elements
#> [1] 2 8 1 1 7 6 9 2 6
#> (in some order)
