...
#> A disord object with hash fe39785e8a190a3d335b2acba451421763de21aa and elements
#> [1] 3 3 3 3 3
#> (in some order)
...
a <- rdis()
a
#> A disord object with hash fba9e699261f8aac3421e9ae40f0df78a1eea3e9 and elements
#> [1] 2 8 1 1 7 6 9 2 6
#> (in some order)
