...
#> A disord object with hash 2e305f4b10eb7fc1a71ebb956e55b32c5984bb69 and elements
#> [1] 3 3 3 3 3
#> (in some order)
...
a <- rdis()
a
#> A disord object with hash 3dea5ed097d726dc41b8cbbf36835000d3be60bb and elements
#> [1] 2 8 1 1 7 6 9 2 6
#> (in some order)
