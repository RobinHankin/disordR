...
#> A disord object with hash 7aeeb112d0b9197e5798a73cfa2733730a6f46c2 and elements
#> [1] 3 3 3 3 3
#> (in some order)
...
a <- rdis()
a
#> A disord object with hash defe803ef9aa16670f2e36ef29d76c698654e0fb and elements
#> [1] 2 8 1 1 7 6 9 2 6
#> (in some order)
