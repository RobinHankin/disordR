...
``` r
(a <- rdis())
#> A disord object with hash 3aa705b67e08f594eb71939433c726edd19d7436 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash bf1dbe3c3f9d679360f2ea344c353477fdbf46d0 and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
