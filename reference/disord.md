...
``` r
(a <- rdis())
#> A disord object with hash 23fc5df86201100016736159a40375011b5ecfd5 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash e9862b5282e127ef2e3ff732af523f312cb71a01 and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
