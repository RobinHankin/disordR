...
``` r
(a <- rdis())
#> A disord object with hash 0673b5ddc1834adf5ba1585f7124ca6ff03c66a7 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash 9d4d319682443816b3a6d547aa14bbb31e78157a and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
