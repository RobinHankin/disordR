...
``` r
(a <- rdis())
#> A disord object with hash 48784968894f43c1477f47be575c4b376b4cf0cb and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash 69019490c58c0b6d659f1b950477d1c470c1cdaf and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
