...
(a <- rdis())
#> A disord object with hash 93d3a823cadf5603c2fc1889b6dc1d451bf8ffd1 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash c3a6cd25d0e3d6bc6b0ede1621ff7f454495be0a and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
