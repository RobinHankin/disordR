...
``` r
(a <- rdis())
#> A disord object with hash 905d777c645d68dfe91a28cd92b71eb7f685dd91 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash 3cd244a7a8a070e207022f3d15ee178630a93f50 and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
