...
``` r
(a <- rdis())
#> A disord object with hash cc6023f25a86bf85ecffd35b2763bb30b068bc8c and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash 494ad35a118c4fb0a69877ada2d7ec64e23791a9 and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
