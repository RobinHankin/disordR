...
(a <- rdis())
#> A disord object with hash 1fdfb713404e4788749609141019806bf1bb9288 and elements
#> [1] 1 6 2 3 1 9 2 5 8
#> (in some order)
(b <- rdis())
#> A disord object with hash 6e101e2013c294b21cba8eb14ea353c602fed795 and elements
#> [1] 3 3 2 7 3 6 4 1 7
#> (in some order)
