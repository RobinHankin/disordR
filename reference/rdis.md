...
``` r
rdis()
#> A disord object with hash 96a3a4020f321f950568466263ef2cdc103f70d4 and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash 9bca29e684ee684c29effff98da5c0ee908aa700 and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 93eacea25606287ae18be263ebde0fbb3d21d446 and elements
