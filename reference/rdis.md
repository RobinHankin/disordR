...
``` r
rdis()
#> A disord object with hash a18252f2dad8fba45c3400e1be1d4b9109f03d0d and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash 8145c4db110faee08475331d22003756e43a30c0 and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 3333fe25ffe4e749b769bc6067d16936d96b4047 and elements
