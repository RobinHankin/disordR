...
``` r
rdis()
#> A disord object with hash 3442b3088ac86c60d8dfb9003b9db6a00a8b9998 and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash fc5e6b18a450602bd3f47fbbd787ae87a9ea46c9 and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 29caba2211b19c74e88263533b01d79ab019a794 and elements
