...
``` r
rdis()
#> A disord object with hash c5a757140efac9ffb146ce9244f044359f119ea6 and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash d3944d3b5737263bb9fa185e84f3d8933510834d and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 5c7f0b915e0e4c4dd2dd3a543d3edd9793ec5312 and elements
