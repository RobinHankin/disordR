...
``` r
rdis()
#> A disord object with hash f0308937f53611cbde8a81828131d95075ae6c52 and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash 04e27ca71454c6efb11975bf7aa248ddc46440d0 and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 0366f55b16b5049dc63ebbab6bc4777cbe01998b and elements
