...
``` r
rdis()
#> A disord object with hash 3797f0d7d33db49ef2079aad7f31d0aab696907b and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash 69a695e6d6511d9f4e5b48742e2dec281e899527 and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash 4fa1a206596fa2f4822ec68f11b4ff4d2b759bc6 and elements
