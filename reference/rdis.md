...
``` r
rdis()
#> A disord object with hash 0f5505463ea181c725cf9232fe267cc752966456 and elements
#> [1] 4 2 9 2 3 3 1 7 5
#> (in some order)
rdis(99)
#> A disord object with hash 4fdf074cce621fd88926c6ea82028706c5515f9a and elements
...
#> (in some order)
rdis(letters)
#> A disord object with hash a24ef80ab2c841e7a0521dacf45290cb1cf36184 and elements
