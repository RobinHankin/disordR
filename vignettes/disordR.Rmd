...
order used is implementation-specific.

Quite often, I am interested in the coefficients themselves.  I might
ask:
...
<- 1:3`and `coeffs(a) <- coeffs(b)` are not defined and will return an
error.  However, note that
...
Extraction presents issues; consider `coeffs(a)<3`.  This
...
meaningful opertion while suppressing inadmissible ones:
