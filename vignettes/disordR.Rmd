...
# `disord` objects as used in the `mvp` package

(This document discusses the `disord` class of objects in the context
of the `mvp` package.  Vignette `disordR` presents a more abstract
discussion of the `disordR` package considered in isolation).
...
of a multivariate polynomial `a` is `coeffs()`; but this cannot return
